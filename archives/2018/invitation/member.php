...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ececec;" bgcolor="#ececec;">
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="40" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left"><p style="color:#5b5f65; font-size:33px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>Congradulations!</strong></p> <br>
    ...
    <table cellpadding="1" cellspacing="15" border="1" width="100%">
   <col width="70%">
  <col width="30%">
    <thead>
      <tr>
        <th align="left">Item</th>
        <th align="right">Amount (LKR)</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td align="right"><strong>2,250</strong></td>
      </tr>
    </tbody>
        ...
        <p style="color:#5b5f65; font-size:13px; text-align:justify; font-family: Verdana, Geneva, sans-serif"><strong>Name:</strong> Manoranjana De Silva</p>

          <p style="color:#5b5f65; font-size:13px; text-align:justify; font-family: Verdana, Geneva, sans-serif"><strong>Mobile Number:</strong> 0713534335</p>
  
          <p style="color:#5b5f65; font-size:13px; text-align:justify; font-family: Verdana, Geneva, sans-serif"><strong>E-mail:</strong> manoranjana@ieee.org</p>
    ...
    <tbody>
      ...
      <tr>
       <td align="left"><img src="https://sywc.ieee.lk/promo/invitation/img/logo2.jpg" width="80px" alt="" style="border-width:0; max-width:80px;height:auto; display:block" /></td>
        <td align="justify"><br><br><p style="color:#000000; font-size:13px; text-align:justify; font-family: Verdana, Geneva, sans-serif">Dulan Dias<br><font size="1" color="#000000">Co-Chair | IEEE SLSYWC 2018</font><br><font size="1" color="#7B7B7B">IEEE Sri Lanka Section<br>Mobile: +94 77 3089692<br>Website:  <a href="https://sywc.ieee.lk" target="_blank">https://sywc.ieee.lk</a></font></p></td>
      </tr>
