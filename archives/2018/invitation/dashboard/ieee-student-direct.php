...
<center class='wrapper' style='width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;'>
  <table width='100%' cellpadding='0' cellspacing='0' border='0' style='background-color:#ececec;' bgcolor='#ececec;'>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td class='one-column' style='padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;'><table border='0' cellpadding='0' cellspacing='0' width='100%' style='border-spacing:0'>
                                          ...
                                          <tr>
                                            <td align='center'><font style='font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left'><a href='#' target='_blank' style='color:#474b53; text-decoration:none'>View in your Web Browser</a></font></td>
                                          </tr>
                                          <tr>
                                            <td align='center'>&nbsp;</td>
                                          </tr>
    ...
    <table cellpadding='5' cellspacing='0' border-collapse='collapse' border='1' width='100%'>
   <col width='70%'>
  <col width='30%'>
    <thead>
      <tr>
        <th align='left'><font size='3'>Item Description</font></th>
    ...
    <tbody>
     ...
     <tr>
		<td align='left'><br><font size='2'>1 x IEEE Sri Lanka Section SYW Congress 2018 (Ticket)</font><br><font size='1'><strong><i>Category: IEEE Student</i></strong></font><br><br></td>
        <td align='right'>$ticketPrice LKR</td>
      </tr>
		
      <tr>
         <td align='right'><strong><font size='3'>Discount</font></strong></td>
        <td align='right'><font size='3'>$discount%</font></td>
      </tr>
      <tr>
        
        <td align='right'><strong><font size='4'>TOTAL</font></strong></td>
        <td align='right'><strong><font size='4'>$totalPrice LKR</font></strong></td>
      </tr>
    </tbody>
								...
								<table>
											<br>
                    <p style='color:#5b5f65; font-size:12px; text-align:justify; font-family: Verdana, Geneva, sans-serif'>Please be kind enough to make your payment to the following bank account and send an image/ photograph of the slip on or before the deadline.</p>      
  
          <table cellpadding='3' cellspacing='0' border-collapse='collapse' border='0' width='100%'>
   <col width='8%'>
  <col width='2%'>
<col width='30%'>
   <tbody>
      <tr>
		  <td><strong><font size='2'>Account Number</font></strong></td>
        <td align='center'><strong><font size='3'>:</font></strong></td>
		  <td align=''><strong><font size='2'>76580808</font></strong></td>
      </tr>
  
      <tr>
        <td><strong><font size='2'>Name</font></strong></td>
        <td align='center'><strong><font size='3'>:</font></strong></td>
		  <td align=''><strong><font size='2'>L.C.R.S Gunasekara</font></strong></td>
      </tr>
      <tr>
        
        <td><strong><font size='2'>Bank</font></strong></td>
        <td align='center'><strong><font size='3'>:</font></strong></td>
		   <td align=''><strong><font size='2'>Bank of Ceylon (BOC)</font></strong></td>
      </tr>
	   
	         <tr>
        
        <td><strong><font size='2'>Branch</font></strong></td>
        <td align='center'><strong><font size='3'>:</font></strong></td>
		   <td align=''><strong><font size='2'>University of Moratuwa Branch - Katubedda</font></strong></td>
      </tr>
    </tbody>
        ...
        <br>
		  ...
		  <p style='color:#5b5f65; font-size:12px; text-align:justify; font-family: Verdana, Geneva, sans-serif'><font color='#D10003'><strong><i>Note: </i></strong></font>It is important that you make sure to indicate your University name and your NIC number for under transaction details on the bank deposit slip.							
		<br><br>							
		 In case you fail to make the payment on or before the deadline, your seat will be offered to the next applicant in line.
<br><br>
Looking forward to having you at the congress!

</p> 
									
<p style='color:#5b5f65; font-size:15px; text-align:justify; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif''>Thank You!</p>									
 ...
 <table cellpadding='1' cellspacing='1' border='0' width='100%'>
  ...
  <col width='50%'>
    ...
    <tbody>
      ...
      <tr>
       <td align='left'><img src='https://sywc.ieee.lk/promo/invitation/img/logo2.jpg' width='102px' alt='' style='border-width:0; max-width:102px;height:auto; display:block' /></td>
          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
				...
				<li class="nav-item">
                <a class="nav-link active" href="https://sywc.ieee.lk/invitation/dashboard/ieee-student-direct">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
...
?> </th> </tr>
  ...
  <div class="row">
    <div class="col-sm-12">
			...
			<h2> <strong>Send Invitations to IEEE Student Members (Direct)</strong></h2>
<br>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="email" placeholder="Delegate's email address(s)" id="email" required>
			  </div>
