...
<center class='wrapper' style='width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;'>
  ...
  <col width='30%'>
    ...
    <tbody>
       ...
       <tr>
		<td align='left'><br><font size='2'>1 x IEEE Sri Lanka Section SYW Congress 2018 (Ticket)</font><br><font size='1'><strong><i>Category: Non-IEEE Student</i></strong></font><br><br></td>
          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
				...
				<li class="nav-item">
                <a class="nav-link active" href="https://sywc.ieee.lk/invitation/dashboard/non-ieee-student-sb">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
...
?> </th> </tr>
  ...
  <div class="row">
    <div class="col-sm-12">
			...
			<h2> <strong>Send Invitations to Non-IEEE Student Members (via Branch)</strong></h2>
<br>
