...
$page = '';
 $sec = "60";
 header("Refresh: $sec; url=https://admin.sywc.ieee.lk/dashboard2");
?>
...
$(document).ready(function() {
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
     ...
     <div class="form-control form-control-dark w-100"> <marquee  scrollamount='5'><font color="#D1CECE">This is a restricted area. Your IP addresses are being traced. Do not miss use the service. - IEEE SLSYWC Webmaster</marquee></font> </div>
...
<tr><th align="left"  width="72%"><h2>Registration List</h2> </th>
