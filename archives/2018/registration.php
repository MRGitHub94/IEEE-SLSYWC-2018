    ...
    <div class="panel-body">
	    ...
	    <div class="error-page text-center">
			...
			<br>
							...
							<p style="color:#797979;">If you have registered already & if selected, you will receive an invitation email to proceed the payments for the participation of IEEE SLSYWC 2018. 
