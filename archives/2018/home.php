...
<head>
	...
	<!-- Site Title -->
	<title>IEEE SYW CONGRESS 2018 | Sri Lanka Section</title>
	<!--Favicon-->
  ...
  <meta property="og:street-address" content="Sri Lanka Technological Campus, Ingiriya Rd"/>
  <meta name="og:locality" content="Padukka"/>
  <meta name="og:region" content="CMB"/>
  <meta name="og:postal-code" content="10500"/>
...
<body>
	...
	<div class="body-inner">
      ...
      <?php require_once 'process/common/sections/venue.php'?>
		...
		<!-- MODALS STARTS-->
        <?php require_once 'process/common/custom/modals.php'?>
        <!-- MODALS ENDS -->
